...
export type RegistrationCreateInput = Schema.Schema.Type<
  typeof RegistrationCreateInputSchema
>
...
export type RegistrationUpdateInput = Schema.Schema.Type<
  typeof RegistrationUpdateInputSchema
>
...
export type RegistrationDeleteInput = Schema.Schema.Type<
  typeof RegistrationDeleteInputSchema
>
...
export type RegistrationListQuery = Schema.Schema.Type<
