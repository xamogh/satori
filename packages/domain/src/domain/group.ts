...
export type PersonGroupCreateInput = Schema.Schema.Type<
  typeof PersonGroupCreateInputSchema
>
...
export type PersonGroupUpdateInput = Schema.Schema.Type<
  typeof PersonGroupUpdateInputSchema
>
...
export type PersonGroupDeleteInput = Schema.Schema.Type<
  typeof PersonGroupDeleteInputSchema
>
...
export type PersonGroupListQuery = Schema.Schema.Type<
  typeof PersonGroupListQuerySchema
>
