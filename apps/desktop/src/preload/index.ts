...
const api: IpcApi = {
  ...
  authModeStatus: () => invokeRoute(IpcRoutes.authModeStatus, undefined),
  authSelectMode: (payload) => invokeRoute(IpcRoutes.authSelectMode, payload),
  authLocalOnboard: (payload) => invokeRoute(IpcRoutes.authLocalOnboard, payload),
  authLocalSignIn: (payload) => invokeRoute(IpcRoutes.authLocalSignIn, payload),
