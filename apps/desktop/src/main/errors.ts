...
export class IpcError extends Schema.TaggedError<IpcError>('IpcError')('IpcError', {
  message: Schema.String,
  channel: Schema.String,
  cause: Schema.Unknown
}) {}

export class FileLoadError extends Schema.TaggedError<FileLoadError>('FileLoadError')(
  'FileLoadError',
  {
    message: Schema.String,
    path: Schema.String,
...
export class ApiAuthError extends Schema.TaggedError<ApiAuthError>('ApiAuthError')('ApiAuthError', {
  message: Schema.String,
...
export class LockedError extends Schema.TaggedError<LockedError>('LockedError')('LockedError', {
  message: Schema.String
}) {}

export class LocalDbOpenError extends Schema.TaggedError<LocalDbOpenError>('LocalDbOpenError')(
  'LocalDbOpenError',
  {
    message: Schema.String,
    path: Schema.String,
...
export class LocalDbQueryError extends Schema.TaggedError<LocalDbQueryError>('LocalDbQueryError')(
  'LocalDbQueryError',
  {
    message: Schema.String,
    query: Schema.String,
...
export class OutboxEncodeError extends Schema.TaggedError<OutboxEncodeError>('OutboxEncodeError')(
  'OutboxEncodeError',
  {
    message: Schema.String,
    cause: Schema.Unknown
